...
# Pearson's Chi$^2$ ($\chi^2$) test {#chi-squared}

If we have counts in two categories (e.g. heads or tails; women or men; democrat or republican; etc.) we can test whether the distribution of observations deviates from a null hypothesis distribution via a [Binomial test](nhst-binomial-test.html) (where the null hypothesis specifies the probability/proportion of "success"  (e.g., heads/women/democrats/whatever): the parameter $\theta$ or $p$).
