...
Based on the [central limit theorem](prob-clt-normal.html) and our derivation of the properties of the [sampling distribution of the sample mean](nhst-sampling-distribution.html), we can undertake some classical (frequentist) statistics.
